  ...
  const getEmptyStateConfig = () => {
    switch (type) {
      case 'no-data':
        return {
          icon: '🚀',
          defaultTitle: 'No technologies yet',
          defaultDescription: 'Get started by adding your first technology to track company tools and frameworks.',
          defaultActionLabel: 'Add Technology'
        }
      case 'no-results':
        return {
          icon: '🔍',
          defaultTitle: 'No technologies found',
      ...
      case 'error':
        return {
          ...
          defaultDescription: 'We encountered an error while loading technologies. Please try again.',
      ...
      <div className="text-muted-foreground max-w-md mx-auto">
        ...
        {onAction && (
          <Button onClick={onAction} className="gap-2">
            ...
            {type === 'error' && <Code className="h-4 w-4" />}
